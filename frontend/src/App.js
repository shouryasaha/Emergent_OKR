...
const App = () => {
  ...
  // Objective Details (keeping existing functionality but updating styles)
  const ObjectiveDetails = () => {
    ...
    // ... (keeping all existing handler functions)
    ...
    return (
      <div className="space-y-6">
        ...
        {/* Rest of the objective details content with updated styling */}
        {/* ... keeping existing functionality but updating to match new design */}
      </div>
    );
  };
